...
ip netns exec mgmt ip link set dev eth0 address 00:00:10:01:01:05
ip netns exec mgmt ip link set eth0 up
ip netns exec mgmt ip addr add 10.1.1.5/24 dev eth0
...
ip netns exec internet ip link set dev eth0 address 00:00:10:02:01:05
ip netns exec internet ip link set eth0 up
ip netns exec internet ip addr add 10.2.1.5/24 dev eth0
...
ip netns exec private ip link set dev eth0 address 00:00:10:03:01:05
ip netns exec private ip link set eth0 up
ip netns exec private ip addr add 10.3.1.5/24 dev eth0
