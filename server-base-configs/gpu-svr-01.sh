...
ip -6 addr add fd00:1:2:1:0:3:0:2/96 dev eth7.1
...
# GPU0
ip route add table 1000 ::/0  via fd00:1:1:1:0:1:0:1
ip -6 rule add from fd00:1:1:1:0:1:0:2 lookup 1000

# GPU1
ip route add table 1001 ::/0  via fd00:1:1:1:0:2:0:1
ip -6 rule add from fd00:1:1:1:0:2:0:2 lookup 1001

# GPU2
ip route add table 1002 ::/0  via fd00:1:1:1:0:3:0:1
ip -6 rule add from fd00:1:1:1:0:3:0:2 lookup 1002

# GPU3
ip route add table 1003 ::/0  via fd00:1:1:1:0:4:0:1
ip -6 rule add from fd00:1:1:1:0:4:0:2 lookup 1003

# GPU4
ip route add table 1004 ::/0  via fd00:1:2:1:0:1:0:1
ip -6 rule add from fd00:1:2:1:0:1:0:2 lookup 1004

# GPU5
ip route add table 1005 ::/0  via fd00:1:2:1:0:2:0:1
ip -6 rule add from fd00:1:2:1:0:1:0:2 lookup 1005

# GPU6
ip route add table 1006 ::/0  via fd00:1:2:1:0:3:0:1
ip -6 rule add from fd00:1:2:1:0:1:0:2 lookup 1006

# GPU7
ip route add table 1007 ::/0  via fd00:1:2:1:0:4:0:1
ip -6 rule add from fd00:1:2:1:0:1:0:2 lookup 1007
